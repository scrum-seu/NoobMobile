...
// var raderdataListAVG = [0.123, 0.435, 0.12, 0.257, 0.62, 0.45];
...
Page({
  ...
  linegetData: function () {
    ...
    var t = this;
    wx:wx.request({
      url: 'https://noob.chinanorth.cloudapp.chinacloudapi.cn:5000/get_consumption_data_info',
      data: {
  ...
  init_rader_echarts: function () {
    ...
    // 向服务器发送请求获取数据
    wx: wx.request({
      url: 'https://noob.chinanorth.cloudapp.chinacloudapi.cn:5000/get_consumption_category_info',
      data: {
